    ...
    <section className="py-4" ref={elmRef}>
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-3xl mx-auto sm:text-center">
          ...
          <p className="text-gray-600 mt-3">Here you can explore and follow CENITS's workshops, talks, gatherings, and seminars as well as community engagements.</p>
        </div>
        <div className="mt-12">
          <ul className="grid gap-12 sm:grid-cols-2 md:grid-cols-2">
            {Array.isArray(events) && events.map((page, idx) => (
