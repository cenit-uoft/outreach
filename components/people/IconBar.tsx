export default [
    ...
    {
        icon:
            <svg className="w-5 h-5 duration-150 hover:text-gray-500" fill="none" viewBox="0 0 48 48" stroke="currentColor" strokeWidth="3">
                {/* Clean, offline personal webpage globe icon mapped to the 48x48 canvas */}
                <circle cx="24" cy="24" r="21" fill="none" />
                <path d="M3 24h42M24 3a42 42 0 0 0 0 42M24 3a42 42 0 0 1 0 42" fill="none" />
                <ellipse cx="24" cy="24" rx="12" ry="21" fill="none" />
                <clipPath>
                    <path fill="currentColor" d="M0 0h48v48H0z" />
                </clipPath>
            </svg>,
    ...
    {
        icon:
            <svg className="w-5 h-5 duration-150 hover:text-gray-500" viewBox="0 0 48 48">
                {/* Uniform, clean typographic bold 'R' fallback grid box for ResearchGate */}
                <text 
                    x="24" 
                    y="38" 
                    textAnchor="middle" 
